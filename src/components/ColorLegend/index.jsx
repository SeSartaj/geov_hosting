...
const ColorLegend = () => {
  ...
  const NDVI_Legend = [
    {
      color: '#004400',
      label: ` (${intl.formatNumber(0.5)} to ${intl.formatNumber(1.0)})`,
    }, // Dark Green
    {
      color: '#0f540a',
      label: ` (${intl.formatNumber(0.4)} to ${intl.formatNumber(0.5)})`,
    }, // Very Dark Green
    ...
    {
      color: '#3f7c23',
      label: ` (${intl.formatNumber(0.25)} to ${intl.formatNumber(0.3)})`,
    }, // Medium Green
    // { color: '#4f892d', label: ` (${intl.formatNumber(0.2)} to ${intl.formatNumber(0.25)})` }, // Medium Green
    // {
    //   color: '#609635',
    //   label: ` (${intl.formatNumber(0.15)} to ${intl.formatNumber(0.2)})`,
    // }, // Medium Green
    ...
    {
      color: '#bcb76b',
      label: ` (${intl.formatNumber(-0.1)} to ${intl.formatNumber(0.0)})`,
    }, // Pale Green
    ...
    {
      color: '#fff9cc',
      label: ` (${intl.formatNumber(-0.35)} to ${intl.formatNumber(-0.3)})`,
    }, // Pale Yellow
    ...
    {
      color: '#c0c0c0',
      label: ` (${intl.formatNumber(-0.7)} to ${intl.formatNumber(-0.6)})`,
    }, // Light Gray
    {
      color: '#0c0c0c',
      label: ` (${intl.formatNumber(-1.0)} to ${intl.formatNumber(-0.7)})`,
    }, // Dark Gray
  ];
  ...
  return (
    <div className="legend">
      <h4 className="mb-2">{rasterLayer?.label}</h4>
      {items.map((item, index) => (
        <div key={index} className="legend-item" style={{ fontSize: '1.4em' }}>
          <span
